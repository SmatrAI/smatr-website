(function () {
  try {
    ...
    var ifrmSrc =
      "https://forms.zohopublic.in/smatrsm1/form/JoinWaitlist/formperma/CKuC-PeS9hmKqy4L46nrWuURa286Ie3Bik1W0YKiJXg?zf_rszfm=1";
    ...
    f.src = ifrmSrc;
    f.style.border = "none";
    f.style.height = "1069px";
    f.style.width = "90%";
    f.style.transition = "all 0.5s ease";
    f.setAttribute("aria-label", "Join Waitlist");

    var d = document.getElementById(
      "zf_div_CKuC-PeS9hmKqy4L46nrWuURa286Ie3Bik1W0YKiJXg"
    );
    if (d) {
      d.appendChild(f);
    }
